...
import textwrap
# ---------- パス設定 ----------------------------------------------------------
video_path        = r"C:\Users\s1280\Desktop\SHRP2rawdata\5\new_divided\scene_019.mp4"
csv_path          = r"C:\Users\s1280\Desktop\SHRP2rawdata\5\csv_divided\scene_019.csv"
...
# ---------- BEV 変換用座標 ----------------------------------------------------
src  = np.load(os.path.join(base_path, "src_points_3_forwardx.npy"))
dst  = np.load(os.path.join(base_path, "dst_points_3_forwardx.npy"))
...
try:
    while cap.isOpened():
        ...
        for i,t in enumerate(tracks):
            ...
            # === 1フレーム以上連続で入っている場合にのみ生成AIをジョブ登録 ===
            if risk_zone_counter[tid] >= 1:

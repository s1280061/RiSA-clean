...
print("\nCoefficient table (low quality, sorted by |coef|):")
print(coef_df)
...
plt.title("Factors associated with low-quality driving advice (overall ≤ 2)\n(sorted by |coefficient|)")

plt.grid(axis="x", alpha=0.3)
plt.tight_layout()

# 保存（論文・修論用）
plt.savefig("figure_logit_coefficients_low_quality_sorted.png", dpi=300)
plt.show()
